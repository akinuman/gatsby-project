...
const AnimePresentation = () => {
  ...
  function InstancedSpheres({ number = 100 }) {
    const map = useLoader(THREE.TextureLoader, TextureImage);
  ...
  return (
    ...
    >
      ...
      <Physics gravity={[0, 0, -10]}>
        ...
        />
        <Plane
          color={niceColors[24][2]}
          position={[6, 0, 0]}
          rotation={[0, -0.9, 0]}
        />
        <Plane
          color={niceColors[24][3]}
          position={[0, 6, 0]}
          rotation={[0.9, 0, 0]}
        />
        <Plane
          color={niceColors[24][0]}
          position={[0, -6, 0]}
          rotation={[-0.9, 0, 0]}
        />
        <Box />
...
export default React.memo(AnimePresentation);
